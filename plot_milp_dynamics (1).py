...
fig.tight_layout()
fig.savefig(f'{OUT}/fig_biomass_dynamics_milp.pdf', dpi=600, bbox_inches='tight')
fig.savefig(f'{OUT}/fig_biomass_dynamics_milp.png', dpi=600, bbox_inches='tight')
plt.close(fig)
...
fig.tight_layout()
fig.savefig(f'{OUT}/fig_metabolite_dynamics_milp.pdf', dpi=600, bbox_inches='tight')
fig.savefig(f'{OUT}/fig_metabolite_dynamics_milp.png', dpi=600, bbox_inches='tight')
plt.close(fig)
